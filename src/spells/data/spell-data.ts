...
export const SPELL_DATA: (NormalSpellType | MeleeRangedSpellType)[] = [
  ...
  },
  {
    ...
    concentration: true,
    components: ["v", "s", "m"],
    material: "seven sharp thorns",
    flavor: "The body of a creature grows dangerously sharp spikes.",
    description: ["The creature gains Spiked 2."],
    atHigherLevels: forEachAboveDo(1, "the Spike increases by 2."),
    sources: ["primal"],
    damageTypes: ["piercing"],
    group: "Physiomorph",
  },
  ...
  },
  {
    ...
    description: [
      "Each creature you choose within the area gains a +10 bonus to Stealth Checks and can't be tracked except by magical means.",
      "A creature that receives this bonus leaves no tracks or other traces of its passage.",
    ],
    atHigherLevels: forEachAboveDo(2, "the radius of the spell doubles."),
    sources: ["primal"],
    tags: ["buff"],
  },
  // {
  ...
  // },
  {
    ...
    duration: "Instantaneous",
    components: ["v", "s"],
    flavor: "You call upon your deity to heal the wounded.",
    description: [
      "Up to six creatures regain hit points equal to 2d12 + your Spellcasting Ability Modifier.",
    ],
    atHigherLevels: forEachAboveDo(2, "the healing increases by 1d12."),
    sources: ["divine"],
    tags: ["heal"],
    group: "Vigor",
  },
  {
    ...
    duration: "1 hour",
    components: ["v", "s"],
    flavor: "You protect a creature from poison.",
    description: [
      "Neutralizes one poison that affects the creature.",
      "The creature gains Resistance to poison damage and has Advantage on Saving Throws against being Poisoned.",
    ],
    atHigherLevels: forEachAboveDo(2, "the duration doubles."),
    sources: ["artificer", "divine", "primal"],
    tags: ["buff"],
  ...
  // },
  {
    ...
    concentration: true,
    components: ["v", "s"],
    flavor: "A black beam of enervating energy springs from your finger.",
    description: [
      "The creature becomes Weak.",
      "At the end of each of its turns, the creature can roll a Constitution Saving Throw, ending the effect on itself on a success.",
    ],
    atHigherLevels: addTarget(2),
    savingThrow: "con",
    sources: ["cleric", "warlock", "wizard"],
    tags: ["debuff"],
  },
  // {
  //   name: "Rope Trick",
  ...
  },
  {
    ...
    ritual: true,
    flavor: "You see the hidden.",
    description: ["Targets don't benefit from being Invisible against you."],
    atHigherLevels: forEachAboveDo(2, "the duration doubles."),
    sources: ["arcane"],
    tags: ["buff"],
  },
  ...
  // },
  {
    ...
    components: ["v", "s"],
    ritual: true,
    flavor: "You shut all sounds.",
    description: [
      "No sound can be created within or pass through the area.",
      "Creatures inside the area are Deafened and immune to Thunder damage.",
    ],
    atHigherLevels: forEachAboveDo(
      2,
      "the radius of the sphere increases by 5 feet."
    ),
    sources: ["wizard", "bard", "cleric"],
    tags: ["area", "control"],
  },
  {
    name: "Shatter",
  ...
  },
  {
    ...
    components: ["v", "s"],
    ritual: true,
    flavor: "You write a message in the sky.",
    description: ["Clouds form a message of up to 10 words."],
    atHigherLevels: forEachAboveDo(2, "the duration doubles."),
    sources: ["druid", "wizard"],
    // tags: ["utility"],
  },
  {
    name: "Spider Climb",
    ...
    concentration: true,
    flavor: "You grant a creature the ability to climb walls and ceilings.",
    description: [
      "The creature gains a Climb Speed equal to your Walking Speed. It can also climb upside down.",
    ],
    atHigherLevels: addTarget(2),
    sources: ["wizard", "primal"],
    tags: ["buff"],
  },
  {
  ...
  },
  {
    ...
    flavor:
      "You manipulate the mind of a creature to force it to take a certain course of action.",
    description: [
      "Creatures that are immune to the Charmed condition are immune to this spell.",
      "You describe in a sentence or two a reasonable course of action. The creature must do its best to follow the suggestion.",
    ],
    atHigherLevels: forEachAboveDo(2, "the duration doubles."),
    sources: ["arcane"],
    savingThrow: "wis",
  ...
  },
  {
    ...
    duration: "1 hour",
    components: ["v", "s", "m"],
    material: "a pair of affordable rings made of a fine metal",
    flavor: "You create a ward between you and an ally to share their pain.",
    description: [
      "The creature is Resistant to all damage and gains +1 to its Armor Class and Saving Throws.",
      "When the creature takes damage, you take the same amount of damage.",
      "**Bond break.** The spell ends if you drop to 0 Hit Points, if you and the target are more than 60 feet apart or if you cast this spell again.",
    ],
    atHigherLevels: forEachAboveDo(2, "the duration doubles."),
    tags: ["buff"],
    sources: ["divine"],
