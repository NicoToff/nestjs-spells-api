...
export const TALENT_DATA: CreateTalentFeatDto[] = [
  ...
  },
  {
    ...
    name: "Armor Training",
    description: [
      "You gain proficiency with light armor. If you already have proficiency with light armor, you gain proficiency with medium armor and shields. If you already have proficiency with medium armor and shields, you gain proficiency with heavy armor.",
  ...
  },
  {
    ...
    prerequisites: ["At least 80 years old"],
    flavor:
  ...
  },
  {
    ...
    description: [
      "You gain the following benefits:",
      "- You learn the *friend* cantrip. Charisma is your spellcasting ability for this spell.",
      "- You gain proficiency in the Deception or Persuasion skill. If you're already proficient in the chosen skill, you gain Expertise in it.",
    ],
  ...
  },
  {
    ...
    name: "Sprinter",
    description: [
      "When you take the Dash action, you can move an extra number of feet equal to half your speed.",
    ],
  ...
  },
  {
    ...
    description: [
      "You gain the following benefits:",
      "- You have a +2 bonus to death Saving Throws.",
      "- You become stable on your second successful death Saving Throw.",
      "- When you make a death Saving Throw and roll a 1 on the d20, it counts as only one failure.",
    ],
    flavor:
  ...
  },
  {
    ...
    description: [
      "You have gain +1 bonus to Strenth, Intelligence, or Charisma Saving Throws.",
      "You can select this talent up to three times, choosing a different Saving Throw each time.",
    ],
    flavor:
  ...
  },
  {
    ...
    name: "War Cry",
    description: [
      "When you reduce a creature to 0 Hit Points, you can use your Reaction to shout and gain a number of Resilience Points equal to your Constitution modifier. These Resilience Points last 1 minute.",
    ],
